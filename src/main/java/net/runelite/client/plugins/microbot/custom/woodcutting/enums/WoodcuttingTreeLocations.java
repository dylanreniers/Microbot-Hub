package net.runelite.client.plugins.microbot.custom.woodcutting.enums;
...
import net.runelite.client.plugins.microbot.custom.woodcutting.ResourceLocationOption;
