package net.runelite.client.plugins.custom.autobankstander.skills.herblore;
...
import net.runelite.client.plugins.custom.autobankstander.skills.herblore.enums.Herb;
...
public class HerbloreProcessor implements BankStandingProcessor {
    ...
    public boolean performBanking() {
        ...
        Rs2Bank.depositAll();
        sleepUntil(() -> Rs2Inventory.isEmpty(), 1200);
    ...
    private boolean bankForCleanHerbs() {
        ...
        boolean withdrawn = sleepUntil(() -> Rs2Inventory.hasItem(currentHerb.grimy), 1200);
        if (!withdrawn) {
