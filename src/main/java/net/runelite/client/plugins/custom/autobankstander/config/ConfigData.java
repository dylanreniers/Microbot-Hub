...
public class ConfigData {
    ...
    private net.runelite.client.plugins.custom.autobankstander.skills.fletching.enums.BoltType fletchingBoltType = net.runelite.client.plugins.custom.autobankstander.skills.fletching.enums.BoltType.BRONZE;
