...
@ConfigInformation("IMPORTANT!<br/>"
        + "This is the <b>custom</b> build of the Demonic Gorilla killer, with combat, prayer, banking and restocking.<br/><br/>"
        + "<p>Requirements:</p>\n"
        + "<ol>\n"
...
@ConfigGroup("Custom Demonic Gorillas")
public interface CustomDemonicGorillaConfig extends Config {
    @ConfigSection(
