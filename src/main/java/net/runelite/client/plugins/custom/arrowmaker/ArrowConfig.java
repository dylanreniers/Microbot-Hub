package net.runelite.client.plugins.custom.arrowmaker;

import net.runelite.client.config.Config;
import net.runelite.client.config.ConfigGroup;
import net.runelite.client.config.ConfigItem;
import net.runelite.client.config.ConfigSection;
import net.runelite.client.plugins.custom.arrowmaker.enums.Arrows;
import net.runelite.client.plugins.custom.arrowmaker.enums.Bolts;
import net.runelite.client.plugins.custom.arrowmaker.enums.Darts;
import net.runelite.client.plugins.custom.arrowmaker.enums.DragonTipping;
import net.runelite.client.plugins.custom.arrowmaker.enums.Tipping;
