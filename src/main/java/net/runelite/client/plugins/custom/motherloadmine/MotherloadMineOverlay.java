...
import static net.runelite.client.plugins.custom.motherloadmine.MotherloadMineScript.status;

@Slf4j
public class MotherloadMineOverlay extends OverlayPanel {
    @Inject
    MotherloadMineOverlay(DonderMotherloadMinePlugin plugin) {
        super(plugin);
    ...
    public Dimension render(Graphics2D graphics) {
        try {
            ...
            panelComponent.getChildren().add(LineComponent.builder()
                    ...
                    .right("Version: " + DonderMotherloadMinePlugin.version)
                    .build());
        } catch (Exception ex) {
