package net.runelite.client.plugins.custom.moonsofperil.enums;
...
public enum Locations {
    ...
    BLOOD_ATTACK_1(new WorldPoint(1391, 9629, 0)),
    ...
    BLUE_ICESHARD_SAFEPOT(WorldPoint.fromRegion(5783, 32, 17, 0)), //1440,
