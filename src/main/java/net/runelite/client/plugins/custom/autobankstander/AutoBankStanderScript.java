package net.runelite.client.plugins.custom.autobankstander;
        ...
        mainScheduledFuture = scheduledExecutorService.scheduleWithFixedDelay(() -> {
            try {
                ...
                switch (state) {
                    case INITIALIZING:
                        handleInitializing();
                        break; // handle the setup phase
                    case BANKING:
                        handleBanking();
                        break; // handle banking operations
                    case PROCESSING:
                        handleProcessing();
                        break; // handle the processing activity
                    case ERROR_RECOVERY:
                        handleErrorRecovery();
                        break; // handle error situations
                }
