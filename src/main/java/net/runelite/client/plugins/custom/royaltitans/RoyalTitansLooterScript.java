...
public class RoyalTitansLooterScript extends Script {
    ...
    @Inject
    private RoyalTitansScript royalTitansScript;

    private static final String[] ITEMS_TO_LOOT = new String[] {
            "Giantsoul amulet",
    ...
    public boolean run(RoyalTitansConfig config, RoyalTitansScript script) {
        ...
        mainScheduledFuture = scheduledExecutorService.scheduleWithFixedDelay(() -> {
            try {
                ...
                if (royalTitansScript.getState().equals(RoyalTitansBotStatus.BANKING) || royalTitansScript.getState().equals(RoyalTitansBotStatus.TRAVELLING) || royalTitansScript.getState().equals(RoyalTitansBotStatus.WAITING))
                    return;
                ...
                if (fireTitanDead != null && iceTitanDead != null) {
                    royalTitansScript.setSubState("Looting ground items");
                ...
                royalTitansScript.setSubState("Handling looting from Titans");
                switch (config.loot()) {
                    case ICE_TITAN:
                ...
                if (looted && !lootedTitanLastIteration) {
                    ...
                    royalTitansScript.increaseKillCount();
