package net.runelite.client.plugins.custom.sulphurnaguafigther;
...
import net.runelite.client.plugins.custom.sulphurnaguafigther.SulphurNaguaScript.SulphurNaguaState;
